...
public class Wordings {
	...
	private static LanguageImplMap<Wording> wording = new ExplicitLanguageImplMap<Wording>(new FakeWording());

	public static Wording getWording() {
		return wording.getCurrent();
	}

	public static void setWording(Wording wording) {
		Wordings.wording.setCurrent(wording);
	}
}
