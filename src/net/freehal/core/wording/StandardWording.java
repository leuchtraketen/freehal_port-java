...
public class StandardWording implements Wording {
	 ...
	 * @Override public List<Word> modifyWords(List<Word> words, XmlList xfact)
	 * { for (Word word : words) { if (!word.hasTags()) {
	 * word.setTags(Taggers.getTagger()); } } return words; } }
	 */
}
