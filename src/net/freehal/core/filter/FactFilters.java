...
public class FactFilters implements FactFilter {
	...
	private static LanguageImplMap<FactFilters> singleton = new ImplicitLanguageImplMap<FactFilters>(
			new Factory<FactFilters>() {
				@Override
				public FactFilters newInstance(String... params) {
					return new FactFilters();
				}
			});
